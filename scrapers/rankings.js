...
const RANKINGS = {
  ...
  tv: {
    ...
    items: [
      ...
      'The Wire Season 5', 'Twin Peaks', 'Twin Peaks The Return',
      'The X Files', 'Buffy the Vampire Slayer', 'Angel',
      'Battlestar Galactica', 'Firefly', 'Stargate SG1',
      'The Twilight Zone', 'Black Mirror Season 3', 'Years and Years',
      'Utopia UK', 'Luther', 'Broadchurch', 'Line of Duty',
      'Happy Valley', 'Shetland', 'Vera',
      'Six Feet Under', 'The Shield', 'Deadwood',
      'Rome', 'Spartacus', 'Boardwalk Empire',
      'True Blood', 'Mad Men', 'Damages',
      'Justified', 'Rectify', 'The Americans Season 6',
      'Halt and Catch Fire', 'Halt and Catch Fire complete',
      'Leftovers', 'The Leftovers complete',
      'Sharp Objects', 'Big Little Lies', 'The Undoing',
      'Watchmen HBO', 'Lovecraft Country', 'Station Eleven',
      'Pachinko', 'The White Lotus', 'The Idol',
      'Industry', 'We Own This City', 'The Wire',
      'Treme', 'Generation Kill', 'Show Me a Hero',
      'Chernobyl complete', 'The Terror', 'From',
      'Yellowstone', '1883', '1923',
      'Tulsa King', 'Mayor of Kingstown', 'Landman',
      'Outer Range', 'Yellowjackets Season 2', 'The Watcher',
      'Midnight Mass', 'The Haunting of Hill House', 'Bly Manor',
      'The Fall of the House of Usher', 'Ratched',
      'Dark Winds', 'Reservation Dogs', 'Rutherford Falls',
      'What We Do in the Shadows Season 5', 'Our Flag Means Death',
      'Interview with the Vampire AMC', 'Mayfair Witches',
      'Better Things', 'Hacks', 'The Flight Attendant',
      'Poker Face', 'The Diplomat', 'Beef',
      'Jury Duty', 'The Bear Season 2', 'Shrinking',
      'Loot', 'Platonic', 'Lucky Hank',
      'Rabbit Hole', 'Citadel', 'The Recruit',
      'Reacher Season 2', 'Jack Ryan', 'Tom Clancy Jack Ryan',
      'Tulsa King Season 2', 'Mayor of Kingstown Season 3',
      'The Gentlemen Netflix', 'Ripley Netflix',
      'Eric Netflix', 'Baby Reindeer', 'Adolescence',
      'Severance Season 2', 'Slow Horses Season 3', 'Silo',
      'Billions complete', 'Succession Season 4',
      'The Righteous Gemstones', 'Barry Season 4',
      'Nathan For You', 'I Think You Should Leave',
      'Mindhunter Season 2', 'Ozark Season 4',
      'Narcos Mexico', 'ZeroZeroZero',
      'Gomorrah complete', 'My Brilliant Friend',
      'Lupin', 'Call My Agent',
      'Squid Game Season 2', 'All of Us Are Dead',
      'Kingdom Korean', 'Crash Landing on You',
      'Vincenzo', 'Extraordinary Attorney Woo',
      'Naruto Shippuden complete', 'Dragon Ball Z complete',
      'Hunter x Hunter', 'Mob Psycho 100',
      'My Hero Academia', 'Re Zero',
      'Made in Abyss', 'Violet Evergarden',
      'Neon Genesis Evangelion', 'Cowboy Bebop',
      'The Expanse complete', 'For All Mankind complete', 'Pachinko',
      'Westworld Season 1', 'Devs', 'Halt and Catch Fire complete',
      'The Leftovers complete', 'Rectify complete',
      'Treme complete', 'The Wire complete',
      'Generation Kill', 'Show Me a Hero',
      'Sharp Objects', 'Big Little Lies',
      'Watchmen HBO', 'Station Eleven', 'The White Lotus',
    ],
  },
